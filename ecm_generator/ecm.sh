...
function evalECM() {
    ...
    ecmHypothesis=$(replaceStr "${ecmHypothesis}" "L2_read_cy" "${rd_wr_cy_arr[2]}")
    ecmHypothesis=$(replaceStr "${ecmHypothesis}" "L2_write_cy" "${rd_wr_cy_arr[3]}")
    ecmHypothesis=$(replaceStr "${ecmHypothesis}" "L3_read_cy" "${rd_wr_cy_arr[4]}")
    ecmHypothesis=$(replaceStr "${ecmHypothesis}" "L3_write_cy" "${rd_wr_cy_arr[5]}")
    ecmHypothesis=$(replaceStr "${ecmHypothesis}" "MEM_read_cy" "${rd_wr_cy_arr[6]}")
    ecmHypothesis=$(replaceStr "${ecmHypothesis}" "MEM_write_cy" "${rd_wr_cy_arr[7]}")
